...
$pdf->SetTitle('Administracion ETAOO'); //Titlo del pdf
...
$query_datos = $pdo->prepare("SELECT * FROM tb_ETAOO WHERE ci = '$ci_estudiante'  ");
$query_datos->execute();
...
$pdf->Image('../public/img/log1.jpg',
    165, 10, 25, 30, 'JPG', true, 150, '', false, false, 0, false, false, false);
$pdf->Image('https://cdn.pixabay.com/photo/2021/10/06/05/17/learn-6684425_960_720.jpg',
    10, 230, 190, 50, 'JPG', true, 150, '', false, false, 0, false, false, false);
...
$html='
<br><br><br><br><br>
<h2><p align="center"><u>Escuela Tecnica de Artes y Oficios de Occidente "ETAOO"</u> <br><br>
<u>Sistema de Matricula 2024</u>
</p>    
</h2>
<br><br>
<p align="justify" style="font-size: 13px;word-spacing: 5pt;line-height: 20pt;">Yo '.$apellidos_nombres.' con C.I.: '.$ci.', estudiante de '.$ano_for.' año de formación de la especialidad de
  '.$especialidad.' doy fe que los datos registrados y cargados en el sistema de matricula son fidedignos para su correspondiente trámite.</p>

<p align="rigth" style="font-size: 12px">La Paz, '.$dia_actual.' de '.$mes.' de '.$ano.'</p>
