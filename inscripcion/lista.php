...
<div class="container" style="background-color: #F9F1E6">
    <div class="row">
        <div class="col-md-4">
            <br>
            <h1>ETAOO</h1>
        ...
        <div class="col-md-4">
            <img src="<?php echo $URL;?>https://pixabay.com/es/illustrations/etaoo-arte-ganador-8370384/"
                 style="margin-top: 10px;float: right" width="100px" alt="">
        </div>
    </div>
    <br>
    <h2 ALIGN="center">Esceula Tecnica de Artes y Oficios "ETAOO"</h2>
    <div class="row" style="background-color: #E56130;color:#ffffff;height: 50px">
        <div class="col-md-12">
            <center>
                <h4 style="margin-top: 10px">LISTADO DE MATRICULADOS</h4></center>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered table-sm" id="table_id">
                                    ...
                                    <?php
                                    $contador = 0;
                                    $query_datos = $pdo->prepare("SELECT * FROM tb_ETAOO WHERE estado = '1' ");
                                    $query_datos->execute();
